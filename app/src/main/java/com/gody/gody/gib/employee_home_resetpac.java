...
//Allows employee to reset customers if they are not able to access their accounr
...
public class employee_home_resetpac extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v)
    {
        try
        {
            ...
            AlertDialog alertDialog = new Builder(this).create();           //Inform employee of new PAC for customer
